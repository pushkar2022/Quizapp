  ...
  return(
    <View style={{flexDirection:'row',alignItems:'center'}}>
      ...
      >
        ...
        <View style={{backgroundColor:'#684aff',borderRadius:25, width:'25%',height:5}}/>
      </View>
    </View>
  )
}
  ...
  return (
    <View style={Global.container}>
      ...
      <View style={{marginTop:20}}>
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('Screen6')} style={{borderWidth:1,borderColor:'gray',height:80,borderRadius:18,flexDirection:'row',}}>
          ...
          <Text style={{marginLeft:10,alignSelf:'center',fontSize:20,fontWeight:'800'}}>Personal</Text>
        </TouchableOpacity>
